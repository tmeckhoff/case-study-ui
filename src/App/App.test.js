...
it('renders Catalog without crashing and finds title and price ', () => {
  const props = {items: {"CatalogEntryView": [{Offers: [{OfferPrice: [{formattedPriceValue: "$139.99"}]}], title: "title", Images: [{AlternateImages: ["image1"]}], purchasingChannelCode: "0"}]}, getItemsData: items => getAllCatalogItems() };
